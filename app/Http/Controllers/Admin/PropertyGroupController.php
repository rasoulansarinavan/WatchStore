...
class PropertyGroupController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('property_groups.index')->with('گروه ویژگی ها با موفقیت انجام شد');
    }
    ...
    public function edit(string $id)
    {
        ...
        return view('admin.property_group.edit', compact('property_group', 'title'));
    }
