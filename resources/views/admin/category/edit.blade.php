                    ...
                    <form method="POST" action="{{route('category.update',$category->id)}}"
                        ...
                        <div>
                            <figure class="avatar avatar">
                                <img src="{{url('images/admin/categories/big/'.$category->image)}}"
                                     class="rounded-circle"
                                     alt="image">
                            </figure>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-2 col-form-label">نام دسته بنذی</label>
                            <div class="col-sm-10">
                        ...
                        <div class="form-group row" data-select2-id="23">
                            ...
                            <div class="col-sm-10">
                                <select class="form-select" name="parent_id" style="width: 100%;" data-select2-id="1"
